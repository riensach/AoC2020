...
foreach($inputArray as $key => $value) {
    ...
    //echo "String: $stringValue :: Letter: $letter :: Range: ".$rangeValues[0]." - ".$rangeValues[1]." - FoundCount: $foundLetterCount<br>";

    if($foundLetterCount >= $lowRangeValue && $foundLetterCount <= $highRangeValue) {
        // Valid PW
        $validPasswords++;
    }
