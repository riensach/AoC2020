...
foreach($inputArray as $key => $value) {
    ...
    $processor = new processCode($accumulatorValue, $instructions, $instructionValue);
...
class processCode
{
    ...
    function checkUsedArgument($checkValue):bool {
        if(isset($this->argumentHistory[$this->instructionID])) {
    ...
    function processInput() {
        ...
        $this->argumentHistory[$this->instructionID] = 1;
        if($operation == 'nop') {
            $this->instructionID++;
            return;
        } elseif($operation == 'acc') {
            $this->accumulatorValue += $argument;
            $this->instructionID++;
